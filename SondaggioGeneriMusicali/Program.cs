...
Console.WriteLine("Percentuale utenti che ascoltano Pop: " + percentualePop + " %");
Console.WriteLine("Percentuale utenti che ascoltano Rock: " + percentualeRock + " %");
Console.WriteLine("Percentuale utenti che ascoltano Jazz: " + percentualeJazz + " %");
Console.WriteLine("Percentuale utenti che ascoltano Elettronica: " + percentualeElettronica + " %");
